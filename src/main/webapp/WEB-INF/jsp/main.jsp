...
<div class="row">
    <div class="col-sm-2 co-md-2" style="background: #d1d6d8; height: 700px;">
        ...
        <div>
            <ul class="nav nav-tabs" id="tab_content" role="tablist">
                <li role="presentation" class="active">
                    <a href="#home" aria-controls="home" role="button" data-toggle="tab">首页 <span
            ...
            <div class="tab-content" id="panel_content">
                <div role="tabpanel" class="embed-responsive embed-responsive-4by3" id="home">
        ...
        $.ajax({
            ...
            success: function (data) {
                    ...
                    if (userEntity.configson_id == 99) {
                        ...
                        $.each(data, function (cid, userEntitys) {
                            if (userEntity.config_menu_id == userEntitys.configson_id) {
                                html += "<a role='button' id='custom2'>" + userEntitys.config_menu_name + "</a>";
                            }
                        })
                        html += "</li></nav></div></div>";
                        html += "</div>";
                ...
                $(".custom2").click(function () {
                    ...
                    $.each(contentTab, function (i, o) {//遍历面板移除默认选中的面板
                    ...
                    $.each(data, function (i, objects) {
                        if (name == objects.config_menu_page) {
                            if (!isFlag) {//判断是否打开界面窗口
                                isFlag = true;//已经打开
                                var tab_html = "<li role=\"presentation\"><a href=\"#" + objects.config_menu_page + "\" aria-controls=\"" + name + "\" role=\"tab\" data-toggle=\"tab\">" + objects.config_menu_page + "<span class=\"glyphicon glyphicon-remove tab_close\" ></span></a></li>";
                                var panel_html = "<div role=\"tabpanel\" class=\"tab-pane\" id=\"" + objects.config_menu_page + "\"><iframe src='" + objects.config_menu_page + "'style='height: 650px; width: 99%'></iframe></div>";
